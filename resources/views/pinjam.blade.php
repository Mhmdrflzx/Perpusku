                ...
                <div class="col-md-8">
                    ...
                    <div class="d-flex flex-column align-items-start" style="font-size: 15px;">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col d-flex gap-3 justify-content-end" style="font-size: 15px">
                                    <form action="{{ route('koleksi.store') }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="buku_id" value="{{ $buku->id }}">
                                        @if ($existingKoleksi)
                                            <button class="btn btn-danger float-end mr-3" type="submit"
                                                style="width: 50px;">
                                                <i class="fas fa-trash"></i> <!-- Tombol Hapus -->
                                            </button>
                                        @else
                                            <button class="btn btn-dark float-end mr-3" type="submit" style="width: 50px;">
                                                <i class="fas fa-save"></i> <!-- Tombol Simpan -->
                                            </button>
                                        @endif
                                    </form>
                                    <button class="btn btn-danger float-end mr-3" style="width: 100px;"
                                        data-bs-toggle="modal" data-bs-target="#exampleModal">Pinjam</button>
                                </div>
                            </div>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="/pinjam" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" class="form-control" id="pinjam"
                                                        name="pinjam">
                                                </div>
                                                <div class="mb-3">
